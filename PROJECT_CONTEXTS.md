...
- The canonical semantic map is the [Root Sequence Ecosystem Map](https://github.com/Root-Sequence/root-sequence/blob/main/ECOSYSTEM.md).
- The curated Wiki project map is [`PROJECTS.md`](PROJECTS.md).
- The live public-repository registry is [`AUTO_PROJECTS.md`](AUTO_PROJECTS.md).
- The documentation-layer and typed-relationship standard lives in [`Root-Sequence/.github`](https://github.com/Root-Sequence/.github/blob/main/DOCUMENTATION_SYSTEM.md).

Canonical projects own substance. The Wiki owns findability, identity, explicit relationships, and history.
